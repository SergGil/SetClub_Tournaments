...
Рейтингова картка (`/players/[id]`) тепер показує й бали "Set Club" за поточний сезон другим
бейджем під бейджем офіційної моделі (Glicko-2/OpenSkill), а не лише офіційний рейтинг. Рядок
рангу ("#N з M гравців") винесено на окремий рядок з виділеним номером — раніше "#6 з 14" тулилось
в один рядок з написом "Парний рейтинг", погано читалось.
- `src/app/players/[id]/page.tsx` — `getSetClubSeasons`/`get{Singles,Doubles}SetClubPoints` для
  найновішого сезону, `RatingCard` показує другий бейдж `Set Club · N` і окремий рядок рангу.
