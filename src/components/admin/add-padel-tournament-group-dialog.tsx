...
import { createPadelTournamentGroupAction } from "@/lib/actions/padel-tournaments";
...
export function AddPadelTournamentGroupDialog({
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const result = await createPadelTournamentGroupAction(tournamentId, name, selected);
      if (result?.error) {
