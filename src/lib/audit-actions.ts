...
export const AUDIT_ACTION_LABEL: Record<AuditAction, string> = {
  ...
  "coffee.settings.update": "Заголовок сторінки меню оновлено",
  "home.panel.update": "Текст панелі на головній оновлено",
  "home.gallery.upload": "Фото \"Життя клубу\" завантажено",
  "home.gallery.delete": "Фото \"Життя клубу\" видалено",
