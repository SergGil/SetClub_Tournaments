...
export const metadata = { title: "Рейтинг (Падел)" };
...
export default async function PadelRatingPage({
  ...
  const parsedSeason = season && season !== PADEL_ROLLING_SEASON ? Number(season) : undefined;
  const activeSeason: PadelSetClubSeason =
    season === PADEL_ROLLING_SEASON
      ? PADEL_ROLLING_SEASON
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Рейтинг (Падел)</h1>
