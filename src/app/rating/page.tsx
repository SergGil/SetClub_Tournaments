...
const INFORMER_SECTIONS = [
  ...
  },
  {
    ...
    body: "Коли пару формує рандомайзер (1 сіяний + 1 несіяний), уже заздалегідь відомо, хто з двох сильніший — адмін позначає це сіянням. Система враховує цю інформацію: сіяний партнер отримує ~60% зміни рейтингу за результат матчу, несіяний — ~40%, і в плюс за перемогу, і в мінус за поразку. Якщо в парі обидва сіяні, обидва несіяні, або пару склали вручну (не за правилом сіяний+несіяний) — такого сигналу немає, і зміна ділиться порівну між тим, наскільки система ще не впевнена в кожному з двох гравців.",
  },
  {
