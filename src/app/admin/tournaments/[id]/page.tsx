...
export default async function AdminTournamentDetailPage({
  ...
  // For EditTournamentGroupDialog's pair-row pre-fill on a DOUBLES tournament -
  // a custom group's teams aren't stored on the group itself (see the schema
  // comment on TournamentGroupMember), only implied by whichever of its own
  // matches (round === the group's name) already exist.
